...
function BlogHighlightsComponent({ recentPosts }: BlogHighlightsProps) {
  return (
    <section id="notes" className="py-20 lg:py-28 bg-black/20 backdrop-blur-sm">
        ...
        <div className="max-w-4xl mx-auto mb-12">
          ...
          <div className="bg-black/30 rounded-lg border border-border p-6 hover:border-primary/50 transition-colors">
            ...
            <div className="flex items-center gap-2 mb-4 text-muted-foreground group">
              ...
              <span className="font-mono text-sm group-hover:text-primary transition-colors">$ cat notes/logbook.md</span>
            </div>
            <div className="flex items-center gap-2 mb-6 text-muted-foreground group">
              <Terminal size={18} className="group-hover:text-primary transition-colors" />
              <span className="font-mono text-sm group-hover:text-primary transition-colors">$ ls notes/featured</span>
            </div>
            ...
            <div className="mt-8 text-center">
              ...
              >
                <Link href="/blog">
                  $ cd ./notes <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
            </div>
          </div>
