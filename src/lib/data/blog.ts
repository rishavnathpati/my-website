...
export const blogPostsData: BlogPostHighlight[] = [
  {
    ...
    imageUrl: 'https://placehold.co/600x400/png?text=Mac+Terminal+Setup',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/600x400/png?text=Beatrex+Ball+Journey',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/600x400/png?text=Hand+Gesture+Recognition',
  ...
  },
  {
    ...
    imageUrl: 'https://placehold.co/600x400/png?text=Hand+Gesture+GUI+Tutorial',
